...
public class EntryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(net.darkseraphim.stickermanager.R.layout.activity_entry);
        overridePendingTransition(0, 0);
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }
        progressBar = findViewById(net.darkseraphim.stickermanager.R.id.entry_activity_progress);
    ...
    private void showStickerPack(ArrayList<StickerPack> stickerPackList) {
        ...
        if (stickerPackList.size() > 1) {
            ...
            finish();
            overridePendingTransition(0, 0);
        } else if (!stickerPackList.isEmpty()){
    ...
    private void showErrorMessage(String errorMessage) {
        ...
        final TextView errorMessageTV = findViewById(net.darkseraphim.stickermanager.R.id.error_message);
        errorMessageTV.setText(getString(net.darkseraphim.stickermanager.R.string.error_message, errorMessage));
    }
